...
class HTTPHandler(SimpleHTTPRequestHandler):
  def send_head(self):
    ...
    def strip_compression_suffix(f, suffix):
    ...
    if path.lower().endswith('gz'):
      ...
      guess_file_type = strip_compression_suffix(guess_file_type, 'gz')
    elif guess_file_type.lower().endswith('.br'):
      self.send_header('Content-Encoding', 'br')
      logv('Serving ' + path + ' as brotli-compressed.')
      guess_file_type = strip_compression_suffix(guess_file_type, 'br')
